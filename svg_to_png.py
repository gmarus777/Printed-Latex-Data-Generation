...
def svg_to_png(images_and_formulas):
    ...
    png_generation_rsvg = f" rsvg-convert  --width=1024 --height=64 --keep-aspect-ratio -b white  temporary_data/generated_svg_images/{image_name} -o generated_png_images/{image_name[:-4]}.png "
